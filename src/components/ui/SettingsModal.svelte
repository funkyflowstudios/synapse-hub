      ...
      <div class="modal-body">
        ...
        <section class="settings-section">
          ...
          <div class="setting-group">
            ...
            <p class="setting-description">Select a contextual color scheme</p>
            <div class="setting-control">
              <PaletteSelector />
            </div>
          </div>
        ...
        <section class="settings-section">
          ...
          <div class="setting-group">
            ...
            <div class="setting-control">
              <button class="toggle-button" aria-pressed="false" aria-label="Toggle high contrast mode">
                <span class="toggle-slider"></span>
              </button>
            </div>
          </div>
        ...
        <section class="settings-section">
          ...
          <div class="setting-group">
            ...
            <div class="setting-control">
              <button class="toggle-button" aria-pressed="true" aria-label="Toggle GPU acceleration">
          ...
          <div class="setting-group">
            ...
            <div class="setting-control">
              <button class="toggle-button" aria-pressed="true" aria-label="Toggle background processing">
                <span class="toggle-slider active"></span>
              </button>
            </div>
          </div>
